...
export default function UserNav({onClick}: UserNavProps) {
  return (
    <ul className='translate-y-[-50%] absolute top-1/2 flex flex-col gap-4 md:left-1/2 md:translate-x-[-50%] md:flex-row md:items-center md:gap-8'>
      <li className=''>
        <NavLink to='recommended' className={buildLinkClass} onClick={onClick}>
          Home
        </NavLink>
      </li>
      <li>
        <NavLink to='library' className={buildLinkClass} onClick={onClick}>
          My library
        </NavLink>
      </li>
    </ul>
